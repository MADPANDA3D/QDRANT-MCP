...
pytestmark = pytest.mark.skipif(
    os.getenv("QDRANT_MCP_RUN_MODEL_INTEGRATION") != "1",
    reason=(
        "real FastEmbed model integration is opt-in; set "
        "QDRANT_MCP_RUN_MODEL_INTEGRATION=1 and optionally FASTEMBED_MODEL_PATH"
    ),
)
...
class TestFastEmbedProviderIntegration:
    ...
    async def test_initialization(self):
        ...
        provider = FastEmbedProvider(
            ...
            model_path=os.getenv("FASTEMBED_MODEL_PATH"),
        )
